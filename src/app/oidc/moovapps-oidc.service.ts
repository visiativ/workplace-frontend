...
import { Observable, BehaviorSubject, Subject, of, combineLatest, ReplaySubject } from 'rxjs';
...
export class MoovappsOidcService {
  ...
  constructor(private oauthService: OAuthService, private router: Router) {
    ...
    this.oauthService.configure(this.buildAuthConfiguration('http://keycloak:9080', 'jhipstare'));
